...
export HADOOP_CLASSPATH="$HADOOP_CLASSPATH:$CLUSTER_HOME/hadoop-lzo/lib/*"
export JAVA_LIBRARY_PATH="$JAVA_LIBRARY_PATH:$CLUSTER_HOME/hadoop-lzo/lib/native"
...
export HADOOP_NAMENODE_HEAPSIZE=6758
export HADOOP_DATANODE_HEAPSIZE=1761
export HADOOP_JOB_HISTORYSERVER_HEAPSIZE=3399
